  ...
  Future<void> _loadAsync(url) async {
    ...
    try {
      ...
      Response response = await dio.get(url,
          options: Options(
            responseType: FastCachedImageConfig.headers == null
                ? ResponseType.bytes
                : null,
            headers: FastCachedImageConfig.headers,
...
class FastCachedImageConfig {
  ...
  ///[headers] can be used to pass headers to the network request it overrides the default response type of the dio request.
  ...
  static Future<void> init({
    ...
    FastCachedImageConfig.headers = headers;
